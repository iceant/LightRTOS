...
A7670C_Result A7670C_CGACT_Test(bool *result, uint32_t timeout_ms) {
    A7670C_Result err = A7670C_RequestWithCmd(Test_Handler, &result, os_tick_from_ms(timeout_ms), "AT+CGACT=?\r\n");
...
A7670C_Result A7670C_CGACT_Read(A7670C_CGACT_Read_Response *result, uint32_t timeout_ms) {
    ...
    A7670C_Result err = A7670C_RequestWithCmd(Read_Handler, result, os_tick_from_ms(timeout_ms), "AT+CGACT?\r\n");
    return err;
}
