...
{
    return A7670C_RequestWithArgs(Write_URL_Handler, response, os_tick_from_millisecond(timeout_ms), "AT+HTTPPARA=\"URL\",\"%s\"\r\n", url);
}
...
{
    return A7670C_RequestWithArgs(Write_URL_Handler, response, os_tick_from_millisecond(timeout_ms), "AT+HTTPPARA=\"CONNECTTO\",%d\r\n", timeout);
}
...
{
    return A7670C_RequestWithArgs(Write_URL_Handler, response, os_tick_from_millisecond(timeout_ms), "AT+HTTPPARA=\"RECVTO\",%d\r\n", timeout);
}
...
{
    return A7670C_RequestWithArgs(Write_URL_Handler, response, os_tick_from_millisecond(timeout_ms), "AT+HTTPPARA=\"CONTENT\",\"%s\"\r\n", content_type);
}
...
{
    return A7670C_RequestWithArgs(Write_URL_Handler, response, os_tick_from_millisecond(timeout_ms), "AT+HTTPPARA=\"ACCEPT\",\"%s\"\r\n", accept_type);
}
...
{
    return A7670C_RequestWithArgs(Write_URL_Handler, response, os_tick_from_millisecond(timeout_ms), "AT+HTTPPARA=\"SSLCFG\",%d\r\n", ssl_cfg_id);
}
...
{
    return A7670C_RequestWithArgs(Write_URL_Handler, response, os_tick_from_millisecond(timeout_ms), "AT+HTTPPARA=\"USERDATA\",\"%s\"\r\n", userdata);
}
...
{
    return A7670C_RequestWithArgs(Write_URL_Handler, response, os_tick_from_millisecond(timeout_ms), "AT+HTTPPARA=\"READMODE\",%d\r\n", read_mode);
}
